-- WAOUH Chat Meet V18.2 — réconciliation idempotente
-- Réapplique intégralement le contrat V18 sous une nouvelle version afin de
-- corriger une migration ancienne marquée comme appliquée mais incomplète.
