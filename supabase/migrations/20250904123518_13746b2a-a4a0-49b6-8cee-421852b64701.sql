...
CREATE INDEX idx_whatsapp_messages_session_name ON public.whatsapp_messages(session_name);
CREATE INDEX idx_whatsapp_messages_timestamp ON public.whatsapp_messages(timestamp DESC);
CREATE INDEX idx_whatsapp_messages_from_to ON public.whatsapp_messages(from_number, to_number);

CREATE INDEX idx_whatsapp_contacts_session_name ON public.whatsapp_contacts(session_name);
CREATE INDEX idx_whatsapp_contacts_phone ON public.whatsapp_contacts(phone_number);
CREATE INDEX idx_whatsapp_contacts_last_message ON public.whatsapp_contacts(last_message_timestamp DESC);
