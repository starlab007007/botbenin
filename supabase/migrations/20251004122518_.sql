-- Supprimer et recréer la fonction avec la correction du type tags
...
BEGIN
  ...
  LOOP
    BEGIN
      ...
      -- Insérer le prospect avec conversion correcte des types
      INSERT INTO prospects (
        ...
        target_database_id,
        v_user_id,
        COALESCE(v_business.name, v_business.company_name, 'Entreprise sans nom'),
