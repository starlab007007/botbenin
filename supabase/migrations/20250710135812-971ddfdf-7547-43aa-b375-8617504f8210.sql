-- CORRECTION DÉFINITIVE DES PROBLÈMES DE SAUVEGARDE DE BOTS (Version Corrigée)
...
-- 6. Assurer que la contrainte UNIQUE existe pour éviter les doublons (méthode compatible)
DO $$ 
BEGIN
    IF NOT EXISTS (
