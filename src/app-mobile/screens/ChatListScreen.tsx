    ...
    <div className="min-h-[100dvh] bg-background">
      <header className="sticky top-0 z-10 bg-[hsl(165_91%_18%)] text-white">
        <div className="px-4 py-3 flex items-center justify-between">
          <h1 className="text-xl font-bold">WaouhApp</h1>
          <Button size="icon" variant="ghost" className="text-white hover:bg-white/15"><Plus className="h-5 w-5" /></Button>
        </div>
      ...
      <main>
        ...
        {!loading && filtered.length === 0 && (
          <div className="p-12 text-center text-muted-foreground">
            ...
            <p className="text-sm">Vos discussions Waouh apparaîtront ici.</p>
          </div>
        )}
