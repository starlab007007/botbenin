...
interface MoovMoneyPaymentModalProps {
  open: boolean;
...
export const MoovMoneyPaymentModal = ({ 
  open, 
  onOpenChange, 
  amountCFA, 
  planName 
}: MoovMoneyPaymentModalProps) => {
    ...
    try {
      ...
      if (data.success) {
        ...
        toast({
          ...
          description: "Veuillez confirmer le paiement sur votre téléphone Moov Money",
        });
      } else {
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="sm:max-w-[425px]">
        <DialogHeader>
          <DialogTitle>Payer avec Moov Money</DialogTitle>
          <DialogDescription>
        ...
        <div className="space-y-4 py-4">
          <div className="space-y-2">
            <Label htmlFor="phone">Numéro de téléphone Moov Money</Label>
            <Input
              id="phone"
