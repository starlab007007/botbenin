    ...
    <DayPicker
      ...
      classNames={{
        ...
        nav_button: cn(
          ...
          "h-7 w-7 bg-white border-gray-300 p-0 opacity-70 hover:opacity-100"
        ),
        ...
        head_row: "flex",
        head_cell:
          "text-gray-900 rounded-md w-9 font-normal text-[0.8rem]",
        ...
        day_selected:
          "bg-gray-800 text-white hover:bg-gray-700 hover:text-white focus:bg-gray-800 focus:text-white",
