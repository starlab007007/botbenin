          ...
          <div className="space-y-5">
            ...
            <div>
              ...
              <div className="space-y-2">
                ...
                <NavItem item={{ title: 'Contact Layer C0–C5', path: '/admin/waouh/contact-layer', icon: Shield, color: 'from-violet-500 to-indigo-600', description: 'Contactabilité, consentement & règles' }} showDescription />
