        ...
        <div className="space-y-1">
          ...
          <div className="flex items-center space-x-4">
            <span className="text-sm text-gray-500">
              Rôle: <span className="font-medium capitalize">{userStats?.role_name || authUser.role}</span>
            </span>
            <span className="text-sm text-gray-500">
              Statut: <span className="font-medium text-green-600">{authUser.status}</span>
            </span>
