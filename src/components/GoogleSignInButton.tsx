...
export const GoogleSignInButton: React.FC<GoogleSignInButtonProps> = ({ 
  ...
  return (
    <Button
      ...
      className="w-full flex items-center justify-center space-x-2 border-gray-300 hover:bg-gray-50 bg-white text-gray-900 relative"
    >
      {isLoading ? (
        <>
        ...
        <>
          ...
          <span>
            {variant === 'signin' ? 'Se connecter avec Google' : 'S\'inscrire avec Google'}
          </span>
        </>
      )}
    </Button>
