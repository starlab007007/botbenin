    ...
    <Card className="uniform-card">
      <Tabs value={selectedTab} onValueChange={onTabChange} className="w-full">
        <TabsList className="grid w-full grid-cols-2 p-1 bg-gray-100 rounded-t-xl">
          <TabsTrigger value="bots" className="flex items-center justify-center space-x-1 sm:space-x-2 text-xs sm:text-sm">
            <Bot className="w-3 h-3 sm:w-4 sm:h-4" />
            <span>Chatbots</span>
          </TabsTrigger>
          <TabsTrigger value="messages" className="flex items-center justify-center space-x-1 sm:space-x-2 text-xs sm:text-sm">
