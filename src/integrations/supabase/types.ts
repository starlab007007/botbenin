...
export type Database = {
  ...
  public: {
    Tables: {
      ...
      waouh_bi_queries: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "waouh_bi_queries_source_id_fkey"
            columns: ["source_id"]
            isOneToOne: false
            referencedRelation: "waouh_bi_sources"
            referencedColumns: ["id"]
          },
        ]
      }
      waouh_bi_rows: {
        ...
        Relationships: [
          {
            foreignKeyName: "waouh_bi_rows_datasource_id_fkey"
            columns: ["datasource_id"]
            isOneToOne: false
            referencedRelation: "waouh_bi_datasources"
            referencedColumns: ["id"]
      ...
      waouh_bi_source_rows: {
        ...
        Relationships: [
          {
            foreignKeyName: "waouh_bi_source_rows_source_id_fkey"
            columns: ["source_id"]
            isOneToOne: false
            referencedRelation: "waouh_bi_sources"
            referencedColumns: ["id"]
      ...
      waouh_partner_stock_movements: {
        ...
        Relationships: [
          {
            foreignKeyName: "waouh_partner_stock_movements_partner_id_fkey"
            columns: ["partner_id"]
            isOneToOne: false
            referencedRelation: "waouh_partner_stats_v"
            referencedColumns: ["partner_id"]
          ...
          {
            foreignKeyName: "waouh_partner_stock_movements_product_id_fkey"
            columns: ["product_id"]
            isOneToOne: false
            referencedRelation: "waouh_partner_products"
            referencedColumns: ["id"]
      ...
      waouh_presence_audit_log: {
        ...
        Relationships: [
          {
            foreignKeyName: "waouh_presence_audit_log_site_id_fkey"
            columns: ["site_id"]
            isOneToOne: false
            referencedRelation: "waouh_presence_sites"
            referencedColumns: ["id"]
          },
        ]
      }
      waouh_presence_events: {
        Row: {
        ...
        Relationships: [
          {
            foreignKeyName: "waouh_presence_events_member_id_fkey"
            columns: ["member_id"]
            isOneToOne: false
            referencedRelation: "waouh_presence_members"
            referencedColumns: ["id"]
          },
          {
            foreignKeyName: "waouh_presence_events_site_id_fkey"
            columns: ["site_id"]
            isOneToOne: false
            referencedRelation: "waouh_presence_sites"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "waouh_presence_events_token_id_fkey"
            columns: ["token_id"]
            isOneToOne: false
            referencedRelation: "waouh_presence_qr_tokens"
            referencedColumns: ["id"]
          },
        ]
      }
      waouh_presence_members: {
        Row: {
          created_at: string
          display_name: string
        ...
        Relationships: [
          {
            foreignKeyName: "waouh_presence_members_site_id_fkey"
            columns: ["site_id"]
            isOneToOne: false
            referencedRelation: "waouh_presence_sites"
            referencedColumns: ["id"]
      ...
      waouh_presence_notification_log: {
        Row: {
          created_at: string
          detail: string | null
          event_id: string
        ...
        Relationships: [
          {
            foreignKeyName: "waouh_presence_notification_log_event_id_fkey"
            columns: ["event_id"]
            isOneToOne: true
            referencedRelation: "waouh_presence_events"
            referencedColumns: ["id"]
          },
          {
            foreignKeyName: "waouh_presence_notification_log_site_id_fkey"
            columns: ["site_id"]
            isOneToOne: false
            referencedRelation: "waouh_presence_sites"
            referencedColumns: ["id"]
      ...
      waouh_presence_qr_tokens: {
        ...
        Relationships: [
          {
            foreignKeyName: "waouh_presence_qr_tokens_site_id_fkey"
            columns: ["site_id"]
            isOneToOne: false
            referencedRelation: "waouh_presence_sites"
            referencedColumns: ["id"]
      ...
      waouh_presence_sessions: {
        ...
        Relationships: [
          {
            foreignKeyName: "waouh_presence_sessions_check_in_event_id_fkey"
          ...
          {
            foreignKeyName: "waouh_presence_sessions_check_out_event_id_fkey"
          ...
          {
            foreignKeyName: "waouh_presence_sessions_member_id_fkey"
            columns: ["member_id"]
            isOneToOne: false
            referencedRelation: "waouh_presence_members"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "waouh_presence_sessions_site_id_fkey"
            columns: ["site_id"]
            isOneToOne: false
            referencedRelation: "waouh_presence_sites"
            referencedColumns: ["id"]
      ...
      waouh_stock_ai_queries: {
        ...
        Relationships: [
          {
            foreignKeyName: "waouh_stock_ai_queries_datasource_id_fkey"
            columns: ["datasource_id"]
            isOneToOne: false
            referencedRelation: "waouh_stock_data_sources"
            referencedColumns: ["id"]
          },
        ]
      }
      waouh_stock_alert_log: {
        Row: {
          created_at: string
          id: string
          product_id: string
        ...
        Relationships: [
          {
            foreignKeyName: "waouh_stock_alert_log_product_id_fkey"
            columns: ["product_id"]
            isOneToOne: false
            referencedRelation: "waouh_partner_products"
            referencedColumns: ["id"]
      ...
      waouh_stock_alert_settings: {
        ...
        Relationships: [
          {
            foreignKeyName: "waouh_stock_alert_settings_partner_id_fkey"
            columns: ["partner_id"]
            isOneToOne: false
            referencedRelation: "waouh_partner_stats_v"
            referencedColumns: ["partner_id"]
      ...
      waouh_stock_external_records: {
        ...
        Relationships: [
          {
            foreignKeyName: "waouh_stock_external_records_datasource_id_fkey"
            columns: ["datasource_id"]
            isOneToOne: false
            referencedRelation: "waouh_stock_data_sources"
            referencedColumns: ["id"]
      ...
      waouh_stock_reorder_requests: {
        ...
        Relationships: [
          {
            foreignKeyName: "waouh_stock_reorder_requests_product_id_fkey"
            columns: ["product_id"]
            isOneToOne: false
            referencedRelation: "waouh_partner_products"
            referencedColumns: ["id"]
    ...
    Views: {
      ...
      waouh_stock_external_records_active: {
        Row: {
          category: string | null
          cost_price_fcfa: number | null
          datasource_id: string | null
    ...
    Functions: {
      ...
      waouh_adjust_partner_stock: {
        Args: {
          ...
          p_product_id: string
          p_quantity: number
          p_stock_minimum?: number
          p_stock_target?: number
        }
        Returns: Json
      }
      ...
      waouh_create_partner_stock_product: {
        Args: {
      ...
      waouh_presence_can_access_site: {
        Args: { p_site_id: string }
        Returns: boolean
      }
      waouh_presence_can_manage_site: {
        Args: { p_site_id: string }
        Returns: boolean
      }
      waouh_presence_claim_memberships: { Args: never; Returns: number }
      waouh_presence_claim_memberships_v5: { Args: never; Returns: number }
      waouh_presence_create_site_v5: {
        Args: {
          ...
          p_require_employee_code: boolean
          p_require_geolocation: boolean
          p_require_pin: boolean
          p_responsible_whatsapp: string
        }
        Returns: {
          active: boolean
          address: string | null
      ...
      waouh_presence_distance_meters: {
        Args: { lat1: number; lat2: number; lon1: number; lon2: number }
        Returns: number
      }
      waouh_presence_is_manager: {
        Args: { p_site_id: string }
        Returns: boolean
      }
      waouh_presence_phone_digits: { Args: { value: string }; Returns: string }
      waouh_presence_preview_qr_v5: { Args: { p_token: string }; Returns: Json }
      waouh_presence_public_preview_v6: {
        Args: { p_token: string }
        Returns: Json
      }
      waouh_presence_record_qr_action: {
        Args: {
