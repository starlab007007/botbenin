...
const QUICK_ACTIONS = [
  { icon: ShoppingBag, title: "Vendre", desc: "Décrivez l’offre, l’Avatar cherche des acheteurs." },
                ...
                <span className="min-w-0 flex-1">
                  <span className="flex items-center gap-2">
                    <span className="truncate text-[11px] font-black text-slate-900">
                      {resolvedDealState?.active
                        ? resolvedDealState.closed ? "Deal conclu" : "L’Avatar accompagne la négociation"
                        : PRESENCE_PHASE_LABEL[agentState.phase]}
                    </span>
