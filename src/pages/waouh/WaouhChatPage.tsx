...
const QUICK_ACTIONS = [
  ...
  { icon: BrainCircuit, title: "Avatar", desc: "Votre assistant pilote tout le parcours." },
];
  ...
  <div className="space-y-4">
    <div className="rounded-2xl border border-emerald-100 bg-gradient-to-br from-emerald-50/80 to-cyan-50/60 p-4">
      ...
      <p className="mt-1 text-xs leading-relaxed text-slate-600">
        Vous parlez à votre Avatar. Il comprend, NEXUS découvre, Signal Fabric classe, le Contact Layer protège et la Deal Room poursuit la négociation dans le même espace.
      </p>
    </div>
