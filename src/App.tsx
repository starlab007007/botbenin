...
const ApresBacPage = lazy(() => import("./pages/apres-bac/ApresBacPage"));
      ...
      <Routes>
          ...
          <Route path="/apres-bac" element={<Navigate to="/app/apres-bac" replace />} />
                  ...
                  <Route path="/documentation" element={<DocumentationPortalPage />} />
                   ...
                   <Route path="/waouh/nexus" element={<Navigate to="/app/avatar?intent=buy" replace />} />
                  ...
                  <Route path="/app" element={<ErrorBoundary fallback={<MobileErrorFallback />}><MobileShell /></ErrorBoundary>}>
                    ...
                    <Route path="avatar" element={<WaouhAvatarPage />} />
                    <Route path="avatar/commerce" element={<WaouhAvatarPage />} />
