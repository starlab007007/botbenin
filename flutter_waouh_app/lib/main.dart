...
class WaouhMessage {
  ...
  factory WaouhMessage.fromJson(Map<String, dynamic> json) => WaouhMessage(
        id: asString(
            json['id'], 'local-${DateTime.now().microsecondsSinceEpoch}'),
...
class Partner {
  ...
  factory Partner.fromJson(Map<String, dynamic> json) => Partner(
        ...
        walletBalance: asNum(json['wallet_balance'] ??
            json['balance'] ??
            json['solde'] ??
            json['total_commissions']),
        totalSales: asNum(json['total_sales'] ??
            json['total_earnings'] ??
...
class PartnerProduct {
  ...
  factory PartnerProduct.fromJson(Map<String, dynamic> json) => PartnerProduct(
        ...
        photos: ((json['photos'] ?? json['media_urls']) as List?)
                ?.map((e) => asString(e))
                .where((e) => e.isNotEmpty)
                .toList() ??
            const [],
...
class KnowledgeBase {
  ...
  factory KnowledgeBase.fromJson(Map<String, dynamic> json) => KnowledgeBase(
        ...
        updatedAt:
            json['updated_at'] == null ? null : asDate(json['updated_at']),
      );
}
...
class WaouhChatController extends ChangeNotifier {
    ...
    try {
      ...
      if (list.isNotEmpty) {
        ...
        if (linked['auth_user_id'] == null) {
          await supabase
              .from('waouh_users')
              .update({'auth_user_id': uid}).eq('id', _waouhUserId!);
        }
        return _waouhUserId;
      }
  ...
  Stream<List<WaouhMessage>> mainMessages() {
    return supabase
        ...
        .order('created_at')
        .map((rows) => [
              ...rows.map(WaouhMessage.fromJson),
              ...optimisticMessages,
  ...
  Future<void> sendConversationMessage(
    ...
    try {
      await supabase.functions.invoke('waouh-operator-send', body: {
...
class StatusController extends ChangeNotifier {
  ...
  Stream<List<WaouhStatus>> statuses([StatusKind? kind]) {
    ...
    return query.map((rows) {
      final list =
          rows.map(WaouhStatus.fromJson).where((s) => s.isActive).toList();
          ...
          child: Column(
            ...
            children: [
              ...
              const Text(
                ...
                style: TextStyle(
                    color: Color(0xFFCDE7DD), fontWeight: FontWeight.w700),
              ),
              ...
              const SizedBox(
                ...
                child: CircularProgressIndicator(
                    strokeWidth: 3, color: WaouhColors.neon),
              ),
            ],
          ),
        ),
...
GoRouter _buildRouter(AuthController auth) {
  ...
  return GoRouter(
    ...
    routes: [
      ...
      GoRoute(
          path: '/app/auth/email', builder: (_, __) => const EmailAuthScreen()),
      GoRoute(
      ...
      ShellRoute(
        ...
        routes: [
          GoRoute(
              path: '/app/chat', builder: (_, __) => const ChatInboxScreen()),
          GoRoute(
              path: '/app/chat/waouh',
          ...
          : NavigationBar(
              ...
              destinations: const [
                ...
                NavigationDestination(
                    ...
                    label: 'WhatsApp IA'),
                NavigationDestination(
                    icon: Icon(Icons.campaign_outlined), label: 'Diffusion'),
                NavigationDestination(
                    icon: Icon(Icons.storefront_outlined), label: 'Partenaire'),
              ],
            ),
    );
  }
                  ...
                  children: [
                    Column(
                      children: [
                        ...
                        const Text('Envoie un message.',
                            textAlign: TextAlign.center,
                            style: TextStyle(
                                color: Colors.white,
                                fontSize: 28,
                                fontWeight: FontWeight.w900)),
                        const Text('Le monde achete.',
                            textAlign: TextAlign.center,
                            style: TextStyle(
      ...
      body: ListView(
        ...
        children: [
          ...
          if (auth.error != null)
            Text(auth.error!,
                style: const TextStyle(
                    color: WaouhColors.red, fontWeight: FontWeight.w700)),
          const SizedBox(height: 12),
          FilledButton(
      ...
      body: ListView(
        ...
        children: [
          ...
          const Icon(Icons.chat_bubble_outline,
              size: 86, color: WaouhColors.neon),
          ...
          if (!sent) ...[
            ...
            TextField(
              ...
              decoration: const InputDecoration(
                  counterText: '', labelText: 'Code a 6 chiffres'),
            ),
            const SizedBox(height: 32),
            FilledButton(
                onPressed: auth.loading
          ...
          children: [
                    ...
                    Expanded(
                      child: Column(
                        ...
                        children: const [
                          ...
                          Text('Achetez · Vendez · Negociez par message',
                              style: TextStyle(
            ...
            Padding(
              ...
              child: Row(
                children: [
                  const Expanded(
                      child: Text('CONVERSATIONS PRODUIT',
                          style: TextStyle(
                              color: WaouhColors.muted,
                              fontWeight: FontWeight.w900))),
                  Text('Voir tout (${convs.length})',
                      style: const TextStyle(
            ...
            if (convs.isEmpty)
                ...
                child: Column(
                  children: [
                    ...
                    const Icon(Icons.forum_outlined,
                        size: 48, color: WaouhColors.muted),
                    const SizedBox(height: 12),
                    const Text('Aucune autre conversation',
                        style: TextStyle(
                            fontSize: 20, fontWeight: FontWeight.w900)),
                    const Text('Envoyez un message a WAOUH et le Monde achete.',
                        textAlign: TextAlign.center),
                    const SizedBox(height: 20),
                    FilledButton.icon(
                        onPressed: () => context.go('/app/chat/waouh'),
              ...
              ...convs.map((c) => Slidable(
                    ...
                    child: ListTile(
                      ...
                      title: Text(c.phoneNumber ?? 'Annonce',
                          style: const TextStyle(fontWeight: FontWeight.w900)),
                      subtitle: Text(c.lastMessage ?? 'Conversation WAOUH',
                          maxLines: 1, overflow: TextOverflow.ellipsis),
                      trailing: Text(stamp(c.updatedAt),
                          style: const TextStyle(
                              color: WaouhColors.muted,
                              fontWeight: FontWeight.w700)),
        ...
        SizedBox(
          ...
          child: ListView(
            ...
            children: [
              ...
              ...StatusKind.values.map((k) => Padding(
      ...
      child: Column(
        ...
        children: [
          Row(
            children: [
              const Expanded(
                  child: Text('Publier un statut · 24h',
                      style: TextStyle(
          ...
          LinearProgressIndicator(
              value: (step + 1) / 4, color: WaouhColors.jade),
          const SizedBox(height: 20),
          if (step == 0)
            ...StatusKind.values.map((k) => Padding(
                  ...
                  child: RadioListTile<StatusKind>(
                    ...
                    title: Text(k.label,
                        style: const TextStyle(fontWeight: FontWeight.w900)),
                    subtitle: Text(k == StatusKind.sell
                        ? 'Urgence vente'
                        : k == StatusKind.buy
                            ? 'Recherche urgente'
                            : 'Promo · info'),
          ...
          if (step == 1) ...[
            TextField(
                ...
                decoration: InputDecoration(
                    labelText:
                        kind == StatusKind.sell ? 'Titre court *' : 'Objet *',
            ...
            TextField(
                ...
                keyboardType: TextInputType.number,
                decoration:
                    const InputDecoration(labelText: 'Prix / budget (FCFA)')),
          ],
          if (step == 2) ...[
            FilledButton.icon(
            ...
            TextField(
                controller: location,
                decoration:
                    const InputDecoration(labelText: 'Ville ou quartier')),
            const SizedBox(height: 12),
            Wrap(
                spacing: 8,
                children: [
          ...
          if (step == 3) ...[
            TextField(
                ...
                maxLines: 5,
                decoration:
                    const InputDecoration(labelText: 'Detail optionnel')),
            const SizedBox(height: 14),
            Row(children: [
              Expanded(
          ...
          child: Column(
            ...
            children: [
              ...
              Row(children: [
                ...
                const SizedBox(width: 12),
                Expanded(
                    child: Text(status.authorName ?? 'WAOUH',
                        style: const TextStyle(
      ...
      child: Column(
        children: const [
          ...
          Text(
            ...
            textAlign: TextAlign.center,
            style: TextStyle(
                color: WaouhColors.muted, fontWeight: FontWeight.w700),
          ),
        ],
      ),
    );
            ...
            .map((intent) => Padding(
                  ...
                  child: ActionChip(
                    avatar: CircleAvatar(
                        ...
                        child:
                            Icon(intent.icon, color: Colors.white, size: 16)),
        ...
        child: Container(
          ...
          child: Column(
            ...
            children: [
              ...
              Text(stamp(message.createdAt),
                  style:
                      const TextStyle(color: WaouhColors.muted, fontSize: 11)),
  ...
  Widget build(BuildContext context) {
    return GridView.builder(
      ...
      itemBuilder: (_, i) => Container(
        decoration: BoxDecoration(
            color: WaouhColors.sky, borderRadius: BorderRadius.circular(14)),
            ...
            itemBuilder: (_, i) {
              ...
              return WaCard(
                ...
                child: ListTile(
                  ...
                  leading: CircleAvatar(
                      backgroundColor:
                          n.read ? WaouhColors.line : WaouhColors.jade,
                      child: Icon(
                          n.type == 'status'
                              ? Icons.auto_awesome
                  ...
                  trailing: Text(stamp(n.createdAt),
                      style: const TextStyle(
                          fontSize: 12, color: WaouhColors.muted)),
                  onTap: () {
                    notifications.markRead(n.id);
                    context.go(n.actionUrl?.startsWith('/app') == true
                        ? n.actionUrl!
                        : '/app/chat/waouh');
                  },
                ),
                  ...
                  child: Column(
                    children: [
                      const Icon(Icons.storefront_outlined,
                          size: 44, color: WaouhColors.muted),
                      const Text('Aucune entreprise',
        ...
        children: [
          Row(
            children: [
              ...
              const SizedBox(width: 12),
              Expanded(
                  child: Text(partner?.name ?? 'Partenaire WAOUH',
                      style: const TextStyle(
          ...
          const SizedBox(height: 18),
          Text('${money(partner?.walletBalance ?? 0)} FCFA',
              style:
                  const TextStyle(fontSize: 30, fontWeight: FontWeight.w900)),
          const Text('Solde disponible · MTN / Moov / Celtiis Money',
              style: TextStyle(
                  color: WaouhColors.muted, fontWeight: FontWeight.w700)),
          const SizedBox(height: 18),
          SizedBox(
                  ...
                  lineBarsData: [
                    LineChartBarData(
                      ...
                      belowBarData: BarAreaData(
                          show: true, color: WaouhColors.jade.withOpacity(.12)),
                    ),
                  ]))),
          Row(children: [
            Expanded(
...
Future<void> showWithdrawalRequest(
    BuildContext context, Partner? partner) async {
    ...
    builder: (sheetContext) => StatefulBuilder(
      builder: (context, setState) => Padding(
        ...
        child: Column(
          ...
          crossAxisAlignment: CrossAxisAlignment.start,
          children: [
            const Text('Configurer Mobile Money',
                style: TextStyle(fontSize: 22, fontWeight: FontWeight.w900)),
            const SizedBox(height: 12),
            ...
            FilledButton.icon(
              onPressed: partner == null
                  ? null
                  : () async {
                      await supabase.from('waouh_partners').update({
      ...
      builder: (_, snapshot) {
        ...
        return WaCard(
          child: Column(
            crossAxisAlignment: CrossAxisAlignment.start,
            children: [
              const Text('Suivi ventes & commissions',
                  style: TextStyle(fontWeight: FontWeight.w900, fontSize: 19)),
              const SizedBox(height: 12),
              if (sales.isEmpty)
                const Text('Aucune vente attribuee pour le moment.'),
              ...sales.take(4).map((s) => ListTile(
                    contentPadding: EdgeInsets.zero,
                    title: Text(s.productName ?? 'Vente WAOUH',
...
class PartnerProductsScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: const PremiumHeader(
          title: 'Produits', subtitle: 'Catalogue partenaire', showBack: true),
      body: StreamBuilder<List<PartnerProduct>>(
        ...
        builder: (context, snapshot) {
          ...
          return ListView(
            padding: const EdgeInsets.all(16),
            children: [
              Text('${products.length} produit(s)',
                  style: const TextStyle(
                      fontWeight: FontWeight.w900, color: WaouhColors.muted)),
              const SizedBox(height: 14),
              if (products.isEmpty)
                WaCard(
                  child: Column(children: [
                    const Icon(Icons.inventory_2_outlined,
                        size: 42, color: WaouhColors.muted),
              ...
              ...products.map((p) => WaCard(
                    child: ListTile(
                      ...
                      isThreeLine: true,
                      trailing:
                          Chip(label: Text(p.available ? 'Dispo' : 'Pause')),
...
class ProductViewerScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: PremiumHeader(
          title: 'Produit', subtitle: product.name, showBack: true),
      body: ListView(
        padding: const EdgeInsets.all(18),
        children: [
          Container(
          ...
          Text(product.category ?? 'Catalogue',
              style: const TextStyle(
                  color: WaouhColors.muted,
                  fontWeight: FontWeight.w800,
                  fontSize: 16)),
          const SizedBox(height: 14),
          Text('${money(product.priceMin ?? 0)} F',
              style:
...
class _WhatsAppIaScreenState extends State<WhatsAppIaScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: const PremiumHeader(
          title: 'WhatsApp IA', subtitle: 'WAHA · Sessions'),
              ...
              ...sessions.map((s) => WaCard(
                    child: ListTile(
                      ...
                      subtitle: Text(s.phone ??
                          'Scan depuis WhatsApp > Appareils connectes'),
...
class _DiffusionScreenState extends State<DiffusionScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: const PremiumHeader(
          title: 'Diffusion WhatsApp', subtitle: 'Campagnes & analytics'),
      body: ListView(
        padding: const EdgeInsets.all(16),
        children: [
          WaCard(
            child: Column(
              ...
              children: [
                ...
                TextField(
                    controller: audience,
                    decoration:
                        const InputDecoration(labelText: 'Audience / tag')),
                const SizedBox(height: 12),
                SwitchListTile(
                  value: aiVariants,
                ...
                FilledButton.icon(
                  onPressed: () async {
                    await supabase.functions
                        .invoke('whatsapp-diffusion-enqueue', body: {
                      'name': name.text,
...
class BotsScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: const PremiumHeader(
          title: 'Bots', subtitle: 'Bases de connaissances'),
...
class ProfileScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: const PremiumHeader(
          title: 'Profil', subtitle: 'Compte & role', showBack: true),
      body: ListView(
        padding: const EdgeInsets.all(16),
        children: [
          WaCard(
                ...
                CircleAvatar(
                    ...
                    child: Text(
                        ...
                        style: const TextStyle(
                            ...
                            fontWeight: FontWeight.w900))),
                const SizedBox(height: 14),
                Text(profile?.fullName ?? 'Utilisateur WAOUH',
                    style: const TextStyle(
