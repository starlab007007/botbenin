...
class WaouhStatus {
  ...
  factory WaouhStatus.fromJson(Map<String, dynamic> json) => WaouhStatus(
    ...
    price: json['price_fcfa'] == null
        ? (json['price'] == null ? null : asNum(json['price']))
        : asNum(json['price_fcfa']),
    location: json['location'] ?? json['city'] ?? json['ville'],
    mediaUrls: <String>[
      if (asString(json['media_url']).isNotEmpty) asString(json['media_url']),
    ...
    views: asNum(json['views_count'] ?? json['views']).toInt(),
  );
}
...
class StatusController extends ChangeNotifier {
  ...
  Future<void> publishStatus({
    ...
    final body = {
      ...
      'media_kind': mediaUrls.isNotEmpty ? 'image' : null,
      'auth_user_id': auth.user?.id,
