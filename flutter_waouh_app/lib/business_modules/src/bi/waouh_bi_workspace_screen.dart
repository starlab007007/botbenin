...
import '../../../live/waouh_bi_smart_chat_screen.dart';
...
class WaouhBiSourceImportScreen extends WaouhBiSmartChatScreen {
  const WaouhBiSourceImportScreen({
    super.key,
    SupabaseClient? client,
    SupabaseClient? supabase,
    dynamic title,
...
class WaouhBiSourceDetailScreen extends WaouhBiSmartChatScreen {
  const WaouhBiSourceDetailScreen({
    super.key,
    SupabaseClient? client,
    SupabaseClient? supabase,
    dynamic title,
