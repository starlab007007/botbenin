...
class _LiveRadarHeroWorkspaceState extends State<LiveRadarHeroWorkspace>
  ...
  Future<void> _scan({bool refreshLocation = false}) async {
    ...
    try {
      ...
      setState(() {
        _items = const [];
        _error =
            'Le Radar n’a pas pu terminer ce scan. Vérifiez la connexion puis relancez.';
      });
    } finally {
  ...
  Future<void> _openItem(LiveRadarItem item) async {
    ...
    final flowAction = switch (action) {
      _RadarAction.interested => 'interested',
        ...
        child: ListView(
          ...
          children: [
            ...
            if (_error != null) ...[
              ...
              _RadarFeedback(
                  text: _error!, onRetry: () => _scan(refreshLocation: true)),
            ],
            ...
            Row(children: [
              ...
              Text('${_items.length}',
                  style: const TextStyle(
                      color: WaouhPalette.jade, fontWeight: FontWeight.w900)),
            ]),
...
class _RadarHero extends StatelessWidget {
  ...
  Widget build(BuildContext context) => Container(
        ...
        decoration: BoxDecoration(
          ...
          boxShadow: const [
            BoxShadow(
                color: Color(0x33075E54), blurRadius: 24, offset: Offset(0, 12))
          ],
        ),
        child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
            ...
            const Expanded(
              child: Column(
                  ...
                  children: [
                    ...
                    SizedBox(height: 2),
                    Text('Détection locale en temps réel',
                        style: TextStyle(
                            color: Color(0xFFC9F5E3),
                            fontSize: 12.5,
              ...
              child: SizedBox(
                ...
                child: Stack(children: [
                  ...
                  ...items.take(24).map((item) {
                    ...
                    final ratio = math
                        .sqrt((item.distanceKm / maxRadiusKm).clamp(0.0, 1.0));
                    ...
                    return Positioned(
                      ...
                      top: y - 21,
                      child:
                          _RadarPoint(item: item, onTap: () => onItemTap(item)),
                    );
                  }),
                  Center(
                    child: Container(
                      ...
                      decoration: BoxDecoration(
                        ...
                        border: Border.all(
                            color: const Color(0xFF6CE6BE), width: 2),
                        boxShadow: const [
                          BoxShadow(color: Color(0x44000000), blurRadius: 12)
                        ],
                      ),
                      child: const BrandMark(
                          size: 56, semanticLabel: 'Radar WAOUH'),
                    ),
                  ),
                  Positioned(
                    left: 0,
                    ...
                    child: Center(
                      child: Container(
                        ...
                        decoration: BoxDecoration(
                            color: const Color(0xDE012E29),
                            borderRadius: BorderRadius.circular(99),
                            border: Border.all(color: const Color(0x556CE6BE))),
                        child: Text(
                          scanning
                              ? 'Balayage en cours…'
                              : '${items.length} signal${items.length > 1 ? 's' : ''} à proximité',
                          style: const TextStyle(
                              color: Colors.white,
          ...
          Row(children: [
            const Icon(Icons.location_on_outlined,
                size: 16, color: Color(0xFFC9F5E3)),
            ...
            if (scannedAt != null)
              Text('Dernier scan ${_scanTime(scannedAt!)}',
                  style:
                      const TextStyle(color: Color(0xFFA9D7C6), fontSize: 11)),
          ]),
        ]),
      );
}
...
class _RadarSweepPainter extends CustomPainter {
  const _RadarSweepPainter(
      {required this.sweep, required this.active, required this.maxRadiusKm})
      : super(repaint: sweep);
  ...
  void paint(Canvas canvas, Size size) {
    ...
    canvas.drawLine(
        Offset(center.dx, 14), Offset(center.dx, size.height - 14), rings);
    canvas.drawLine(
        Offset(14, center.dy), Offset(size.width - 14, center.dy), rings);
    if (active) {
    ...
    _label(canvas, '$maxRadiusKm km',
        Offset(center.dx + 7, center.dy - radius + 8), labelStyle);
  }
...
class _ScanStatePill extends StatelessWidget {
  ...
  Widget build(BuildContext context) => Container(
        ...
        decoration: BoxDecoration(
          ...
          border: Border.all(
              color:
                  scanning ? const Color(0x55F6BD60) : const Color(0x556AF1C2)),
        ),
  ...
  Widget build(BuildContext context) => Container(
        ...
        child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
          const Row(children: [
            ...
            SizedBox(width: 7),
            Text('Contrôles du scan',
                style: TextStyle(fontWeight: FontWeight.w900, fontSize: 16)),
          ]),
          const SizedBox(height: 5),
          Text('Affinez le Radar après avoir visualisé les opportunités.',
              style: TextStyle(
                  color: WaouhPalette.muted, fontSize: 12, height: 1.3)),
          const SizedBox(height: 13),
          Wrap(spacing: 8, runSpacing: 8, children: [
            _ControlPill(
                icon: Icons.near_me_outlined,
                label: 'Portée · $radiusKm km',
                onTap: onFilters),
            _ControlPill(
            ...
            _ControlPill(
                ...
                label: urgent ? 'Urgence activée' : 'Urgence',
                tone: urgent ? _ControlTone.danger : _ControlTone.neutral,
                onTap: onUrgent),
          ]),
          const SizedBox(height: 14),
          SizedBox(
            ...
            child: FilledButton.icon(
              ...
              label:
                  Text(scanning ? 'Analyse en cours…' : 'Scanner maintenant'),
  ...
  Widget build(BuildContext context) {
    ...
    return OutlinedButton.icon(
          ...
          Positioned(
            ...
            child: Container(
              ...
              decoration: const BoxDecoration(
                  color: WaouhPalette.red, shape: BoxShape.circle),
              child: Text('$badge',
                  style: const TextStyle(
                      color: Colors.white,
                      fontSize: 9,
      ...
      style: OutlinedButton.styleFrom(
        ...
        side: BorderSide(
            color: danger ? const Color(0xFFF1B8BC) : const Color(0xFFBDDCD0)),
        backgroundColor:
            danger ? const Color(0xFFFFF2F3) : const Color(0xFFF8FCFA),
...
class _RadarFeedback extends StatelessWidget {
  ...
  Widget build(BuildContext context) => Container(
        ...
        decoration: BoxDecoration(
            ...
            border: Border.all(color: const Color(0xFFF2DCA6))),
        child: Row(children: [
          ...
          Expanded(
              child: Text(text,
                  style: const TextStyle(
                      fontSize: 12, color: WaouhPalette.muted))),
          ...
          child:
            ...
            Expanded(
              child: Stack(fit: StackFit.expand, children: [
                _NetworkOrFallback(
                    url: item.photoUrl,
                    icon: item.type == LiveRadarItemType.buy
                        ? Icons.search_rounded
                        : Icons.shopping_bag_outlined),
                Positioned(
                  left: 7,
  ...
  Widget build(BuildContext context) {
    if (url == null || url!.isEmpty) {
      return ColoredBox(
          ...
          child: Center(child: Icon(icon, color: WaouhPalette.jade, size: 34)));
    }
...
class _RadarEmpty extends StatelessWidget {
  ...
  Widget build(BuildContext context) => Container(
        ...
        decoration: BoxDecoration(
            color: Colors.white,
            border: Border.all(color: const Color(0xFFDFEAE6)),
            borderRadius: BorderRadius.circular(22)),
        child: Column(children: [
          const BrandMark(size: 58, semanticLabel: 'WAOUH'),
          const SizedBox(height: 14),
          const Text('Aucune opportunité détectée',
              style: TextStyle(fontSize: 19, fontWeight: FontWeight.w900)),
          const SizedBox(height: 7),
          const Text(
              'Élargissez la portée ou les filtres, puis relancez un scan ponctuel.',
                    ...
                    if ((item.description ?? '').trim().isNotEmpty)
                      Padding(
                          ...
                          child: Text(item.description!,
                              style: const TextStyle(
                                  color: WaouhPalette.muted, height: 1.35))),
                    const SizedBox(height: 12),
                    Text(
                        '${item.city ?? 'À proximité'} · ${item.distanceLabel} · ${liveRadarFreshness(item.freshnessMs)}',
                        style: const TextStyle(
                            color: WaouhPalette.muted, fontSize: 12)),
                    const SizedBox(height: 20),
                    Row(children: [
                      Expanded(
                          child: OutlinedButton(
                              onPressed: () => Navigator.pop(
                                  context, _RadarAction.interested),
...
class _RadarFiltersSheetState extends State<_RadarFiltersSheet> {
  ...
  late final TextEditingController _category =
      TextEditingController(text: _value.category ?? '');
              ...
              child: Column(
                ...
                Center(
                    child: Container(
                        ...
                        decoration: BoxDecoration(
                            ...
                            borderRadius: BorderRadius.circular(99)))),
                const SizedBox(height: 16),
                const Text('Affiner le Radar',
                    style:
                        TextStyle(fontSize: 21, fontWeight: FontWeight.w900)),
                const SizedBox(height: 16),
                const Text('Type d’opportunité',
                ...
                TextField(
                    ...
                    decoration: const InputDecoration(
                        labelText: 'Catégorie', hintText: 'Ex. Téléphones')),
                const SizedBox(height: 12),
                Row(children: [
                  Expanded(
                      child: TextField(
