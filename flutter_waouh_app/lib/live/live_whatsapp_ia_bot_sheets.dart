...
class _BotSheetState extends State<_BotSheet> {
  late final LiveWhatsAppIaBotService service =
      LiveWhatsAppIaBotService(legacy.supabase);
                ...
                children: [
                  ...
                  if (bots.isEmpty)
                    ...
                    ...bots.map((bot) => Padding(
                        ...
                        child: InkWell(
                            onTap: () => setState(() => selected = bot.id),
  ...
  Future<void> save() async {
    ...
    try {
      await service.addWebhook(
          sessionName: widget.sessionName, value: url.text);
      if (!mounted) return;
      Navigator.pop(context);
      ScaffoldMessenger.of(context).showSnackBar(const SnackBar(
          content: Text('Webhook ajouté.'),
      ...
      child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
        ...
        TextField(
            ...
            decoration: const InputDecoration(
                ...
                hintText: 'https://exemple.com/webhook')),
        const SizedBox(height: 8),
        const Text(
