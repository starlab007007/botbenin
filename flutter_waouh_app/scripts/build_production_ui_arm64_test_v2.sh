...
test -f scripts/repair_agent_native_compile.py || fail "Correctif Agent IA absent."
...
python3 scripts/repair_agent_native_compile.py

dart format \
  lib/live/agent_quick_create_sheet.dart \
  lib/live/agent_sandbox_panel.dart
