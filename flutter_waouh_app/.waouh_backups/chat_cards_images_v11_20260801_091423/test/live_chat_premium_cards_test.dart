...
✅ Partenaire vérifié''',
  ...
  testWidgets('a loading or invalid network image never replaces the timeline',
      (tester) async {
    ...
    final message = LiveMessage(
      ...
      attachments: const [
        LiveAttachment(
          url: 'https://invalid.example.test/photo.jpg',
          type: 'image/jpeg',
        ),
      ],
    );
    ...
    expect(find.byIcon(Icons.broken_image_outlined), findsAtMostNWidgets(1));
  });
}
